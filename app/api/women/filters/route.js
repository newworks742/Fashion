...
export async function GET() {
  try {
    ...
    const subcategoryQuery = `
      ...
      FROM product 
      WHERE category = 'Women' AND subcategory IS NOT NULL
    ...
    const typeQuery = `
      ...
      FROM product 
      WHERE category = 'Women' AND type IS NOT NULL
      ORDER BY type
    `;
    ...
    const colorQuery = `
      ...
      FROM product 
      WHERE category = 'Women' AND colors IS NOT NULL AND colors != ''
      ORDER BY color
    `;
    ...
    const sizeQuery = `
      ...
      FROM product 
      WHERE category = 'Women' AND sizes IS NOT NULL AND sizes != ''
      ORDER BY size
    `;
